    ...
    <footer className="bg-dark pt-24 pb-12">
      <div className="container">
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-12 text-slate-400 font-medium md:w-1/3">
            <h3 className="text-white font-bold text-2xl mb-5">Hubungi Saya</h3>
            <p>ceretsot@gmail.com</p>
            <p>Jl.Patah jali No. 12</p>
            <p>Tulungagung</p>
          </div>
          <div className="w-full px-4 mb-12 md:w-1/3 "></div>

          <div className="w-full px-4 mb-12 md:w-1/3 ">
            <h3 className="text-white font-bold text-2xl mb-5">Tautan</h3>
        ...
        <div className="w-full pt-10 border-t border-slate-800">
          <div className="flex items-center justify-center mb-5">
            {/*INSTAGRAM*/}
            <a
              href="https://www.instagram.com/fonso.79/"
              target="_blank"
            ...
            {/*IIKTOK*/}
            <a
              href="https://www.tiktok.com/@fonzznt"
              target="_blank"
